...
public class ExperimentoFinalParte4_GGA extends ExperimentoFinalParte3_GGA_v02 {
	
	@Override
	public String getIdExperimento() {
		return "Final_Parte4_GGA";
	}
	...
	public static void main(String[] args) throws Exception {
		int i = 0;
		List<Parametro> params = new ExperimentoFinalParte4_GGA().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte4_GGA();
