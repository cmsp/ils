...
public class ExperimentoFinalParte3_GGA_v02 extends ExperimentoModel  {

	@Override
	public String getIdExperimento() {
		return "Final_Parte3_GGA_V02";
	}
	...
	{		
		...
		Parametro paramGFPadrao = new Parametro(TipoAlgoritmo.GENETICO_FALKENAUER_NORMALIZADO,nCiclos);
		...
		paramGF.setTipoMutacao(TipoMutacao.MOVE_JOIN_SPLIT_V02);
	...
	public static void main(String[] args) throws Exception {
		int i = 0;
		List<Parametro> params = new ExperimentoFinalParte3_GGA_v02().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte3_GGA_v02();
