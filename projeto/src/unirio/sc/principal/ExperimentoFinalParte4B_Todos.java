...
public class ExperimentoFinalParte4B_Todos extends ExperimentoModel {
	
	@Override
	public String getIdExperimento() {
		return "Final_Parte4B_Todos";
	}
	...
	{		
		...
		setMultiplicadorMaxEvaluation(params, 200);
	...
	public static void main(String[] args) throws Exception {
		int i = 0;
		List<Parametro> params = new ExperimentoFinalParte4B_Todos().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte4B_Todos();
