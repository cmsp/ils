...
public class ExperimentoFinalParte4_HC extends ExperimentoFinalParte3_HC {
	
	@Override
	public String getIdExperimento() {
		return "Final_Parte4_HC";
	}
	...
	public static void main(String[] args) throws Exception {
		int i = 0;
		List<Parametro> params = new ExperimentoFinalParte4_HC().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte4_HC();
