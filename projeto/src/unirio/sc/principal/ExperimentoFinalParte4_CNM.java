...
public class ExperimentoFinalParte4_CNM extends ExperimentoFinalParte3_CNM {
	
	@Override
	public String getIdExperimento() {
		return "Final_Parte4_CNM";
	}
	...
	public static void main(String[] args) throws Exception {
		int i = 0;
		List<Parametro> params = new ExperimentoFinalParte4_CNM().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte4_CNM();
