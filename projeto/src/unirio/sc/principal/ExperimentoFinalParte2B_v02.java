...
public class ExperimentoFinalParte2B_v02 extends ExperimentoModel {
	
	@Override
	public String getIdExperimento() {
		return "Final_Parte2B_GGA_v02";
	}
	...
	{		
		...
		Parametro paramGFPadrao1 = new Parametro(TipoAlgoritmo.GENETICO_FALKENAUER_NORMALIZADO,nCiclos);
		paramGFPadrao1.setGenetico(
				...
				percentualGrupoA, 
				percentualGrupoB, 
				TipoMutacao.MOVE_JOIN_SPLIT_V02,
				TipoCrossover.FALKNAUER_NORMALIZADO,
				maxProporcaoGrupos,
		...
		Parametro paramGF2 = getVariacaoGeneticoGF(paramGFPadrao1, 100.00, TipoMutacao.JOIN_V02);
		Parametro paramGF3 = getVariacaoGeneticoGF(paramGFPadrao1, 100.00, TipoMutacao.MOVE_JOIN_SPLIT_V02);
		Parametro paramGF4 = getVariacaoGeneticoGF(paramGFPadrao1,  10.00, TipoMutacao.NENHUMA);
		Parametro paramGF5 = getVariacaoGeneticoGF(paramGFPadrao1,  10.00, TipoMutacao.JOIN_V02);
		Parametro paramGF6 = getVariacaoGeneticoGF(paramGFPadrao1,  10.00, TipoMutacao.MOVE_JOIN_SPLIT_V02);
	...
	public static void main(String[] args) throws Exception {
		List<Parametro> params = new ExperimentoFinalParte2B_v02().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte2B_v02();
