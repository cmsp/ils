...
public class ExperimentoFinalParte3_CNM extends ExperimentoModel {
	
	@Override
	public String getIdExperimento() {
		return "Final_Parte3_CNMLL";
	}
	...
	public static void main(String[] args) throws Exception {
		List<Parametro> params = new ExperimentoFinalParte3_CNM().getParametros();
		...
		ExperimentoModel experimento = new ExperimentoFinalParte3_CNM();
